...
export default class Atendimentos extends Component {
    ...
    componentDidMount() {
        this.carregarListaAtendimentos();
    }

    carregarListaAtendimentos = async () => {
        try {
                ...
                <View style={stylesAtendimentos.itemMain}>
                    <View style={stylesAtendimentos.itemTable}>
                        <View style={stylesAtendimentos.tr}>
                            ...
                            <Text style={stylesAtendimentos.td}>{item.idProntuarioNavigation.nome}</Text>
                        </View>
